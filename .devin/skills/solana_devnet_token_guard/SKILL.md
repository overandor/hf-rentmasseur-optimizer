---
name: solana_devnet_token_guard
description: Design SPL-token visibility layers for receipts while blocking mainnet speculation.
---

# Solana Devnet Token Guard

## Trigger
Use when receipts or credits are represented as Solana devnet or localnet tokens.

## Core job
Design SPL-token visibility layers for receipts while blocking mainnet speculation.
